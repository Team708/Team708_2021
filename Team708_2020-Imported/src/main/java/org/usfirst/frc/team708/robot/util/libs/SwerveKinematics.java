...
public class SwerveKinematics {
	...
	public void calculate(double x, double y, double rotate){
		double A = x - rotate * (Constants.kDT_WHEELBASE_LENGTH / Constants.kDT_SWERVE_DIAGONAL);
		double B = x + rotate * (Constants.kDT_WHEELBASE_LENGTH / Constants.kDT_SWERVE_DIAGONAL);
	    double C = y - rotate * (Constants.kDT_WHEELBASE_WIDTH / Constants.kDT_SWERVE_DIAGONAL);
		double D = y + rotate * (Constants.kDT_WHEELBASE_WIDTH / Constants.kDT_SWERVE_DIAGONAL);
